...
const resources = {
  ...
  hi: {
    translation: {
      ...
      "hero_subtitle": "कोई बिचौलिया नहीं।",
      "hero_desc": "मंडी-कनेक्ट पूरे भारत में किसानों को सीधे खुदरा विक्रेताओं से जोड़ता है। उचित मूल्य प्राप्त करें और ऑर्डर ट्रैक करें।",
